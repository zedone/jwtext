				...
				<div class="content">
					...
					<div class="jd_choice">
						...
						?>
							...
							<div class="tool">
								<span style="margin-left:10px;cursor: pointer;position: relative;top:3px;"><img src="images/111.png"></span>
								<span style="color:#aaa;font-size:14px;position: relative;top:-1px;">(想要上传图片吗？点左边(#^.^#)  &nbsp &nbsp &nbsp想要上传文件？点右边(#^.^#))</span>
								<span style="cursor: pointer;position: relative;top:3px;"><img src="images/112.png"></span>
							</div>
