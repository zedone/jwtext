...
<body>
	...
	<div id="mainbody">
		 <div class="mainbox">
				...
				<input type="text" class="xuehao" name="code" placeholder="验证码" id="validate" style="margin-top:20px;margin-left:85px">
				...
				<button  id="begin" style="margin-top:25px;width:250px;height:40px;border:1px solid rgb(62,118,177);background:rgb(62,118,177);border-radius: 5px;">登录</button>
